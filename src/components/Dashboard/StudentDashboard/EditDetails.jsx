...
function EditDetails() {
  ...
  const img = require('../../../assets/images/graduation.jpg');
  const {
    auth: { user, loading },
  } = useSelector((state) => {
    return {
  ...
  const [formData, setFormData] = useState({
    ...
    aadhar_front_picture: user.aadhar_front_picture,
    aadhar_back_picture: user.aadhar_back_picture,
    cancel_check: user.cancel_check,
  });
            ...
            <div className='col-12 justify-content-center form-outer'>
              ...
              >
                <div className='row' style={{ display: 'flex' }}>
                  <div className='col-md-12 text-center d-sm-block d-md-block'>
                    <>
